  ...
  return (
    <header className="bg-white shadow-md p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        {/* Botón de Iniciar Sesión / Menú de Usuario */}
        <div className="flex items-center space-x-4">
          <Link href="/signin" className="bg-red-700 text-white px-4 py-2 rounded-md hover:bg-red-800 transition-colors">
            Iniciar sesión
          </Link>
          {/* Aquí podríamos añadir un menú desplegable si el usuario ya está logueado */}
        </div>

        {/* Icono de menú para móviles (lo implementaremos más adelante si es necesario) */}
        <div className="md:hidden">
          <button className="text-gray-700 focus:outline-none">
            {/* Aquí iría un ícono de hamburguesa */}
